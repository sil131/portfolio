      ...
      <section className="hero" id="about">
        ...
        <div className="bio animate__animated animate__shakeX">
          ...
          <p className="bio-text">
            Un apasionado desarrollador web que acaba de completar su formación. Mi fascinación por la tecnología me ha llevado a explorar el mundo del desarrollo web, donde he adquirido habilidades sólidas en HTML, CSS, JavaScript y React.
          </p>
          <p className="bio-text">
